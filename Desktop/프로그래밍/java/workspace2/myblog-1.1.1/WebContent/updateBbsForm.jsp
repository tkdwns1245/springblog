...
<%
	...
	String pageNum = request.getParameter("pageNum");
		...
		Bbs article = dao.updateGetArticle(num);
%>
...
%>
	...
	<div class="container" id="content">
		...
		<div class="row">
			...
			<form class="col-lg-8" method="post" name="writeForm" action="updateBbs.proc.jsp"
										onsubmit="return writeSave()">
			<table class="table table-striped table-bordered">
				<tr>
					<td class="attr">제목</td>
					<td><input class="form-control" type="text" name="title" value="<%=article.getTitle()%>"/></td>
				</tr>
				<tr>
					<td class="attr">내용</td>
					<td>
						<textarea class="form-control"name="content" rows="25" cols="50"><%=article.getContent()%></textarea>
					</td>
				</tr>
				<tr>

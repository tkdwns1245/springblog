	...
	<div class="container" id="content">
		<div class="row">
			...
			<div class="col-lg-6 blog-header" style="margin-bottom:50px; text-align:center">
			    <h1 class="blog-title">글수정</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-2"></div>
			<form class="col-lg-8" method="post" name="writeForm" action="${pageContext.request.contextPath}/databoard/updatePro.do?pageNum=${pageNum}"
			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					<td class="attr">내용</td>
					<td>
						<textarea class="form-control" name="content" rows="25" cols="50">${article.content}</textarea>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" class="attr">
						...
						<input class="btn btn-primary" type="button" value="목록"
								onClick="javascript:window.location='${pageContext.request.contextPath}/databoard/list.do?pageNum=${pageNum}'">
					</td>
				</tr>
			</table>
